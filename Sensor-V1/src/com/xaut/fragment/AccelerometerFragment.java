...
public class AccelerometerFragment extends Fragment implements
	...
	private static final String[] person = { "安洋", "姜政冬", "刘娜", "蒋文杰", "李湘", "贾金鹏",
		"高哲", "王辉", "帽帽", "其他"};

	private static final String[] action = { "静坐", "上楼", "下楼", "步行" };
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (accelerometer != null) {
			...
			accshow.setText("名称：" + accelerometer.getName() + "\n\n版本："
